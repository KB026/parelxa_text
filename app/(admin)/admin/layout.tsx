...
export default async function AdminLayout({
  ...
  const navLinks = [
    ...
    { href: '/admin/reviews', label: 'Review Queue', icon: '⏳', accent: '#fbbf24' },
    { href: '/admin/listings', label: 'Manage Listings', icon: '📦' },
    { href: '/admin/transactions', label: 'Transactions', icon: '💳', accent: '#34d399' },
    { href: '/admin/claims', label: 'Listing Claims', icon: '🔑' },
    { href: '/admin/users', label: 'User Management', icon: '👥' },
    { href: '/admin/moderation/reviews', label: 'Review Moderation', icon: '🛡️' },
    { href: '/admin/verifications', label: 'Verification Queue', icon: '✓', accent: '#60a5fa' },
    { href: '/admin/promotions', label: 'Promotions & Revenue', icon: '💰', accent: '#fb923c' },
