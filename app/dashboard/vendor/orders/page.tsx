    ...
    <section>
      ...
      <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border-subtle)', borderRadius: '16px', padding: '24px' }}>
        <table style={{ width: '100%', textAlign: 'left', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            {[
              { id: '#ORD-902', date: '2026-04-05', customer: 'Acme Corp', product: 'Enterprise API', amount: '₹120,000', status: 'Completed', statusColor: '#34d399', statusBg: '#064e3b' },
              { id: '#ORD-901', date: '2026-04-03', customer: 'TechFlow India', product: 'Chatbot Pro Module', amount: '₹25,000', status: 'Pending', statusColor: '#fbbf24', statusBg: '#713f12' },
            ].map(order => (
              <tr key={order.id}>
