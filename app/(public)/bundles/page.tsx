      ...
      <main className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-24">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-5">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-tight">
            AI Kits for Every <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#12B886] to-emerald-400">Team</span>
          </h1>
          ...
          <div className="pt-6 grid grid-cols-2 gap-4 max-w-lg mx-auto border-t border-white/10 text-center">
            ...
            <div>
              <div className="text-2xl sm:text-3xl font-extrabold text-[#12B886]">1-Click</div>
        ...
        <div className="mt-24 p-8 sm:p-12 rounded-3xl bg-gradient-to-b from-[#121216] to-[#09090B] border border-white/10 text-center relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-[#12B886]/10 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/ai-finder"
              className="inline-flex items-center justify-center px-6 py-3.5 rounded-xl bg-[#12B886] hover:bg-[#0fa678] text-black font-bold text-sm transition-all duration-200 shadow-lg shadow-[#12B886]/20"
            >
