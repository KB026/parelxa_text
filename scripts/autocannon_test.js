...
async function runTest() {
  console.log('\\n======================================================');
  console.log('🚀 INITIATING PARLEXA LOAD TEST: STAGE 1 (FRONTEND CACHE)');
  console.log('======================================================\\n');
  ...
  console.log(`⏱️ Avg Latency: ${result1.latency.average} ms`);
  console.log(`🔥 Total Requests Handled: ${result1.requests.total}`);
  console.log(`⚠️ Errors / 5XX Responses: ${result1.errors} / ${result1.non2xx}`);
  console.log(`------------------------------------------------------\\n`);
  ...
  console.log('======================================================');
  console.log('🚀 INITIATING STAGE 2: DYNAMIC DATABASE LOOKUP (BACKEND)');
  console.log('======================================================\\n');
  ...
  console.log(`⏱️ Avg Latency: ${result2.latency.average} ms`);
  console.log(`🔥 Total Requests Handled: ${result2.requests.total}`);
  console.log(`⚠️ Errors / 5XX Responses: ${result2.errors} / ${result2.non2xx}`);
  console.log('\\n======================================================');
